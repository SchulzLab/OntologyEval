...
observed.distance.matrix<-compute.Observed.Distance(OberservedScoreMatrix,Log2=argsList$Log2,Center=argsList$Center,Scale=argsList$Scale,nPCA=as.numeric(argsList$nPCA),method=argsList$ObservedSimMethod)
